    ...
    >
      ...
      <defs>
          ...
          >
            {animateMarkers && (
              <>
                ...
                <animate 
                  attributeName="fill" 
                  values="black; #FFD700; #FFA500; black" 
                  dur="3s" 
                  repeatCount="indefinite"
                />
                <animate 
                  attributeName="stroke" 
                  values="#232323; #FFD700; #FFA500; #232323" 
                  dur="3s" 
                  repeatCount="indefinite"
                />
              </>
        ...
        <linearGradient id="cpu-text-gradient" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor={textColor === "#FFD700" ? "#B8860B" : "#666666"}>
            <animate
          ...
          <stop offset="25%" stopColor={textColor}>
            <animate
              attributeName="offset"
              values="-1; 0; 1"
              dur="5s"
          ...
          <stop offset="50%" stopColor={textColor === "#FFD700" ? "#B8860B" : "#666666"}>
            <animate
              attributeName="offset"
              values="0; 1; 2;"
              dur="5s"
